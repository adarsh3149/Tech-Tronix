...
function Navbar2() {
  ...
  return (
<>
    <Box sx={{width:"100vw",heigt:"10rem",backgroundColor:"transparent",position:"sticky",top:"0",zIndex:"2",display:"flex",justifyContent:{xs:"center",md:"space-between"},padding:"2rem 4rem",flexDirection:{xs:"column",lg:"row"},alignItems:"center"}}>
